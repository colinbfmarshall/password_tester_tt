...
class QueriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post queries_url, params: { query: { password: @query.password, result: @query.result } }
    end
  ...
  test "should update query" do
    patch query_url(@query), params: { query: { password: @query.password, result: @query.result } }
